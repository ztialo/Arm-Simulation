...
def setup_scene():
    ...
    desk_cfg = sim_utils.UsdFileCfg(usd_path="/pvc/project-files/zi/arm/objects/workDesk_new.usd") # change this path base on ur machine accordingly
    ...
    leftArm_cfg = sim_utils.UsdFileCfg(usd_path="/pvc/project-files/zi/arm/piper_description/urdf/piper_description/piper_description.usd")
    leftArm_cfg.func("/World/Workspace/LeftArm", leftArm_cfg, translation=(-0.25, -0.5, 0.794))

    rightArm_cfg = sim_utils.UsdFileCfg(usd_path="/pvc/project-files/zi/arm/piper_description/urdf/piper_description/piper_description.usd")
